   ...
   <section class="l-section py-5">
    <div class="container">
        ...
        <div class="text-center mb-5">
            ...
            <p class="text-muted">
                Internal Quality Assurance Cell (IQAC) is formed in the college as per the UGC guideline.
            </p>
        </div>
        ...
        <div class="text-center">
            <a href="/path-to/IQAC-Committee.pdf" target="_blank" class="btn btn-primary">
                Download IQAC Committee PDF
            </a>
        </div>
