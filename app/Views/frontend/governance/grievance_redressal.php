    ...
    <section class="l-section py-5">
        <div class="container">
            ...
            <div class="text-center mb-5">
                ...
                <p class="text-muted">
                    Grievance Redressal Cell is established in the college as per the UGC (Grievance Redressal)
                    Regulation, 2018.
                </p>
            </div>
            ...
            <div class="text-center">
                <a href="/path-to/Grievance-Redressal-Cell.pdf" target="_blank" class="btn btn-primary">
                    Download Grievance Redressal Committee PDF
                </a>
            </div>
