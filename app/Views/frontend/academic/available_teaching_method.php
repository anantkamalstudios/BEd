...
<!-- Available Teaching Methods Table -->
<div class="container my-5">
    <h3 class="text-center mb-4 text-primary">Available Teaching Methods</h3>
        ...
        <table class="table table-bordered table-hover shadow rounded">
            ...
            <tbody>
                <?php if (!empty($teaching)): ?>
                    <?php $i = 1; foreach ($teaching as $method): ?>
                        <tr>
                            <td><?= $i++ ?></td>
                            <td><?= esc($method['designation']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="2" class="text-center">No teaching methods found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
