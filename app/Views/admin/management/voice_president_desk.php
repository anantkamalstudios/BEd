...
<div class="page-inner">
    <h1 class="mb-4">President Page</h1>

    <?php if (session()->getFlashdata('success')) : ?>
        <div class="alert alert-success"><?= session()->getFlashdata('success') ?></div>
    <?php endif; ?>

    <form action="<?= base_url('save_vice_president_desk') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            <div class="card-header fw-bold">Vice President</div>
            <div class="card-body">
