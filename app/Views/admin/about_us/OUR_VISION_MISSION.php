...
<div class="page-inner">
    <h1 class="mb-4">Vision & Mission Page</h1>
    <?php if (session()->getFlashdata('success')) : ?>
        <div class="alert alert-success"><?= session()->getFlashdata('success') ?></div>
    <?php endif; ?>

   <form action="<?= base_url('vision_mission_page') ?>" method="post" enctype="multipart/form-data">
        <!-- Hero Section -->
        <div class="card mb-4">
        ...
        <!-- Vision & Mission -->
        <div class="card mb-4">
            <div class="card-header fw-bold">Vision & Mission</div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="fw-bold">Mission</label>
