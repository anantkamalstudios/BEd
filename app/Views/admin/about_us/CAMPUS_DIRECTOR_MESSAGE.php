...
<div class="page-inner">
    <h1 class="mb-4">Campus Director's Message</h1>

    <?php if (session()->getFlashdata('success')) : ?>
        <div class="alert alert-success"><?= session()->getFlashdata('success') ?></div>
    <?php endif; ?>

    <form action="<?= base_url('save_campus_director') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            <div class="card-header fw-bold">Campus Director's Message</div>
            <div class="card-body">
                ...
                <div class="form-group col-12 mb-3">
                    <label>Campus Director's Image</label>
                ...
                <div class="mb-3">
                    <label>Campus Director's Name</label>
                    <input type="text" name="campus_director_desk_name" class="form-control" required value="<?= esc($desk['name'] ?? '') ?>">
                </div>
                <div class="mb-3">
