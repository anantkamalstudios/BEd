...
<div class="page-inner">
    <h1 class="mb-4">Award received</h1>
...
<br>
   ...
   <table class="table table-bordered">
        ...
        <?php foreach ($teaching as $row): ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= base_url('delete_award/' . $row['id']) ?>" 
            ...
            <div class="modal fade" id="editTeachingModal<?= $row['id'] ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $row['id'] ?>" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <form action="<?= base_url('update_award') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="designation" class="form-control" value="<?= esc($row['name']) ?>" required>
                                </div>
    ...
    <div class="modal fade" id="heroModal" tabindex="-1" aria-labelledby="heroModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <form action="<?= base_url('save_award') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
