...
<div class="page-inner">
    <h1 class="mb-4">Government Permissiom</h1>

    <?php if (session()->getFlashdata('success')) : ?>
        <div class="alert alert-success"><?= session()->getFlashdata('success') ?></div>
    <?php endif; ?>

    <form action="<?= base_url('save_governmentpermission') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            <div class="card-header fw-bold">President's Message</div>
            <div class="card-body">
