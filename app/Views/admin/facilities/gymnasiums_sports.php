...
<div class="page-inner">
    <h1 class="mb-4">gymnasiums sports</h1>

    <?php if (session()->getFlashdata('success')) : ?>
        <div class="alert alert-success"><?= session()->getFlashdata('success') ?></div>
    <?php endif; ?>

    <form action="<?= base_url('save_gymnasiums_sports_hero_section') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            <div class="card-header fw-bold">gymnasiums sports</div>
            <div class="card-body">
                <div class="mb-3">
                    <label>laboratary content</label>
                 ...
                 <div class="mb-3">
                    ...
                    <?php if (!empty($hero['image'])): ?>
                        <img src="<?= base_url('public/uploads/' . $desk['image']) ?>" alt="Hero Image" class="img-thumbnail mt-2" width="200">
                    <?php endif; ?>
                </div>
            </div>
        </div>
