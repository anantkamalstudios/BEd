    ...
    <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
                <img src="<?= base_url() ?>public/front_end/img/brahma valley logo B.ed.png" alt="navbar brand" class="navbar-brand"  />
            </a>
            ...
            <ul class="nav nav-secondary">
                        ...
                        <ul class="nav nav-collapse">
                            <li>
                                 <a href="<?= base_url('courousel_section') ?>">
                                    <span class="sub-item text-uppercase">Carousel Section</span>
                                </a>
                            </li>
                            <li>
                                 <a href="<?= base_url('our_unique_methodologies') ?>">
                                    <span class="sub-item text-uppercase">Our Unique Methodologies</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('about_us') ?>">
                                    <span class="sub-item text-uppercase">About Us</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('admission_information') ?>">
                                    <span class="sub-item text-uppercase">Admission Information</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('why_join_bvce') ?>">
                                    <span class="sub-item text-uppercase">Why Join BVCE (B.Ed)</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('our_infrastructure') ?>">
                                    <span class="sub-item text-uppercase">Our Infrastructure</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('frequently_asked_questions') ?>">
                                    <span class="sub-item text-uppercase">Frequently Asked Questions</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('gallery') ?>">
                                    <span class="sub-item text-uppercase">Gallery</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#management">
                        <i class="fas fa-layer-group"></i>
                        <p class="text-uppercase">Management</p>
                        <span class="caret"></span>
                    </a>
                        ...
                        <ul class="nav nav-collapse">
                            <li>
                                ...
                                <a href="<?= base_url('PRESIDENT_MESSAGE') ?>">
                                    <span class="sub-item text-uppercase">President Message</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('GENERAL_SECRETARY_MESSAGE') ?>">
                                    <span class="sub-item text-uppercase">General Secretary Message</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('VICE_PRESIDENT') ?>">
                                    <span class="sub-item text-uppercase">Vice President Desk</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('board_of_director') ?>">
                                    <span class="sub-item text-uppercase">Board Of Director</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarLayouts">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="bramha_valley_bed_college">
                                    <span class="sub-item text-uppercase">Bramha Valley BED College</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?= base_url('OUR_VISION_MISSION') ?>">
                                    <span class="sub-item text-uppercase">OUR VISION AND MISSION</span>
                                </a>
                            </li>

                            <li>
                                <a href="silents_features">
                                    <span class="sub-item text-uppercase">Silent Feature</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#">
                                    <span class="sub-item text-uppercase">committees </span>
                                </a>
                            </li>

                            <li>
                                <a href="<?= base_url('admin/ncte_organization_page') ?>">
                                    <span class="sub-item text-uppercase">NCTE Recognition Revise Order</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('Governmentpermission') ?>">
                                    <span class="sub-item text-uppercase ">Government Permission</span>
                                </a>
                            </li>

                            <li>
                                <a href="<?= base_url('Award_recive') ?>">
                                    <span class="sub-item text-uppercase">Award Received</span>
                                </a>
                            </li>

                            <li>
                                <a href="<?= base_url('approvalsaffliation') ?>">
                                    <span class="sub-item text-uppercase">Approvals Affliation</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="<?= base_url('CAMPUS_DIRECTOR_MESSAGE') ?>">
                                    <span class="sub-item">VICE PRESIDENT DESK</span>
                                </a>
                            </li>
                            ...
                            <li>
                             ...
                             <li>
                                <a href="board_of_director">
                                    <span class="sub-item">Board Of Director</span>
                                </a>
                            </li> -->
                            ...
                            <li>
                             ...
                             <li>
                                <a href="<?= base_url('STUDENTS_DEVELOPMENT_COMMITTEE') ?>">
                                    <span class="sub-item">COLLEGE DEVELOPMENT COMMITTEE</span>
                                </a>
                            </li>
                            <li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="submenu">
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="<?=base_url('Available_teaching_method')?>">
                                    <span class="sub-item text-uppercase">Availabla Teaching Method</span>
                                </a>
                            </li>
                                                        <li>
                                ...
                                <div class="collapse" id="subnav2">
                                    <ul class="nav nav-collapse subnav">
                                        <li>
                                            <a href="#">
                                                <span class="sub-item">PLO & CLO</span>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <li>
                                <a href="#">
                                    <span class="sub-item">STUDENT ELIGIBILITY</span>
                                </a>
                            </li>

                            <li>
                                <a data-bs-toggle="collapse" href="#subnav3">
                                    <span class="sub-item text-uppercase ">Lesson Department</span>
                                    <span class="caret"></span>
                                </a>
                                <div class="collapse" id="subnav3">
                                    <ul class="nav nav-collapse subnav">
                                        <li>
                                            <a href="#">
                                                <span class="sub-item">LIST OF SCHOOL</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span class="sub-item">FY</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span class="sub-item">SY</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                <a href="#">
                                    <span class="sub-item">BEd CET INTER-SC-MERIT</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                 ...
                 <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#submenus">
                        <i class="fas fa-bars"></i>
                        <p class="text-uppercase">Admission</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse" id="submenus">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="<?= base_url('req_doc') ?>">
                                    <span class="sub-item text-uppercase">Required document</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#submenuss">
                        <i class="fas fa-bars"></i>
                        <p>FACILITIES</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse" id="submenuss">
                        <ul class="nav nav-collapse">
                            <!-- <li>
                                <a data-bs-toggle="collapse" href="#subnav1">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="<?= base_url('librari') ?>">
                                    <span class="sub-item text-uppercase">library</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('librari') ?>">
                                    <span class="sub-item text-uppercase">laboratary</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?= base_url('gymnasiums_sports') ?>">
                                    <span class="sub-item text-uppercase">gymnasium sport</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('transports') ?>">
                                    <span class="sub-item text-uppercase">transport</span>
                                </a>
                            </li>

                            <li>
                                <a href="<?= base_url('transports') ?>">
                                    <span class="sub-item text-uppercase">Audio and Video</span>
                                </a>
                            </li>
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#chartss">
                        <i class="far fa-chart-bar"></i>
                        <p class="text-uppercase">Media</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse" id="chartss">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="photoes">
